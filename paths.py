...
# Define target dir for generalised "universal" TRFs
ALICE_GENERAL_TRF_DIR = ALICE_TRF_DIR / 'generalised'
FUGLSANG_GENERAL_TRF_DIR = FUGLSANG_TRF_DIR / 'generalised'
...
'''
for directory in [ALICE_ROOT, ALICE_PREDICTOR_DIR, ALICE_TRF_DIR, ALICE_GENERAL_TRF_DIR, ALICE_FIGURES_DIR, ALICE_EEG_DIR, ALICE_STIMULUS_DIR, ALICE_PROCESSED_PREDICTOR_DIR, 
                  FUGLSANG_ROOT, FUGLSANG_PREDICTOR_DIR, FUGLSANG_TRF_DIR, FUGLSANG_GENERAL_TRF_DIR, FUGLSANG_FIGURES_DIR, FUGLSANG_DATA_PREPROC, FUGLSANG_EEG_DIR, FUGLSANG_STIMULUS_DIR,
                  SNHL_ROOT, SNHL_STIMULUS_DIR]:
    directory.mkdir(parents=True, exist_ok=True)